...
public class NoteAdepter extends RecyclerView.Adapter<NoteAdepter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull NoteAdepter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.noteTitle.setText(arrayList.get(position).getTitle());
        holder.noteContent.setText(arrayList.get(position).getContent());
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("description",arrayList.get(position).getContent());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            noteContent = itemView.findViewById(R.id.tvContent);
